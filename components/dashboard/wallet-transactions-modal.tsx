...
} from "@/lib/actions/wallet-transactions";
...
export const WalletTransactionsModal = ({
  open,
  onOpenChange,
  date,
  locationId,
  ...
  const loadTransactions = async () => {
    setLoading(true);
    const result = await getWalletTransactions(date, locationId, useFiscalDate, excludeVat, excludeNoPayment);
    if (result.data) {
