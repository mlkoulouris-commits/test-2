...
import { createUser, type UserRole } from '@/lib/actions/users'
...
export const CreateUserDialog = ({ locations }: CreateUserDialogProps) => {
  const { t } = useLanguage()
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              ...
              <Select name="role" required disabled={isLoading} defaultValue="staff_member">
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
          ...
          <DialogFooter>
            ...
            <Button type="submit" disabled={isLoading}>
              {isLoading ? t('banks.creating') : t('users.createUser')}
            </Button>
          </DialogFooter>
        </form>
      </DialogContent>
